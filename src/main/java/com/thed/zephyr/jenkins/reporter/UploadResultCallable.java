...
public class UploadResultCallable extends MasterToSlaveFileCallable<Boolean> {
    ...
    private static final String pInfo = String.format("%s [INFO]", PluginName);
    ...
    public UploadResultCallable(String serverAddress, String projectKey,
                                ...
                                TaskListener listener, int buildNumber, StandardUsernamePasswordCredentials standardUsernamePasswordCredentials) {
        ...
        this.standardUsernamePasswordCredentials = standardUsernamePasswordCredentials;
    }
    ...
    public boolean perform(int buildNumber, final TaskListener listener) throws IOException, InterruptedException {
        ...
        try {
            ...
            StandardUsernamePasswordCredentials upCredentials = standardUsernamePasswordCredentials;
...
//                boolean prepareZephyrTests = prepareZephyrTests(build, zephyrConfigModel);
            ...
            loop1:
            for (Map.Entry<TCRCatalogTreeTestcase, Map<String, Object>> caseEntry : tcrStatusMap.entrySet()) {
    ...
    private boolean prepareZephyrTests(final Run build, ZephyrConfigModel zephyrConfig) throws IOException, InterruptedException, ParserConfigurationException, SAXException {
        ...
        if (isMavenProject) {
            ...
            try {
                List<AggregatedTestResultAction.ChildReport> result = testResultAction1.getChildReports();
...
//		zephyrConfig.setPackageNames(packageNames);
    ...
    public Map<TCRCatalogTreeTestcase, Map<String, Object>> createTestcasesFromMap(Map<String, TCRCatalogTreeDTO> packagePhaseMap, List<Map> dataMapList, ZephyrConfigModel zephyrConfigModel, PrintStream logger) throws URISyntaxException, IOException {
        ...
        loop1:
        for (Map<String, Map<String, Object>> map : testcaseNameValueMapList) {
